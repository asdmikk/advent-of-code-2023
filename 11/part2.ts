...
const initialGalaxies = getGalaxies(map)
const expandedGalaxies = getGalaxies(expandEmptySpace(map))

const initialDistancesTotal = getDistancesTotal(initialGalaxies)
const expandedDistancesTotal = getDistancesTotal(expandedGalaxies)

const expansionMultiplier = expandedDistancesTotal - initialDistancesTotal

const longExpansionDistancesTotal =
  initialDistancesTotal + expansionMultiplier * (1_000_000 - 1)

console.log(longExpansionDistancesTotal)
